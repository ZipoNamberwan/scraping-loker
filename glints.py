...
def connect_to_existing_edge():
    ...
    driver.get("https://glints.com/id/opportunities/jobs/explore?country=ID&locationId=06c9e480-42e7-4f11-9d6c-67ad64ccc0f6&locationName=Jawa+Barat&lowestLocationLevel=2&educationLevel=HIGH_SCHOOL&page=1")
